...
* **Vision Coprocessor Hosting**: The computer vision stack (*GompeiVision*) runs on a dedicated small-form-factor Linux Mini PC. This hosting environment supports low-latency USB camera capture (via V4L2) and runs the ML note and target detection pipelines.

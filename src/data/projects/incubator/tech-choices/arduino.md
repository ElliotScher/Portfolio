...
*   **Analog Input (ADC)**: Utilizes the built-in Analog-to-Digital Converter on an analog input pin to sample the photodetector voltage output directly, filtering electrical noise before transmitting data.
